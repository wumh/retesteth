    ...
    try
    {
        ...
        requireJsonFields(_data, "EthGetBlockBy " + _data.getKey(),
            {{"logsBloom", {{DataType::String}, jsonField::Required}},
             ...
             {"pstotal", {{DataType::String}, jsonField::Required}},
             {"psAverage", {{DataType::String}, jsonField::Required}},
             ...
             {"tasksRoot", {{DataType::String}, jsonField::Required}},
             {"CreditHash", {{DataType::String}, jsonField::Required}},
