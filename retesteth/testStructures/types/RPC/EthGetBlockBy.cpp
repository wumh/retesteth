    ...
    try
    {
        ...
        requireJsonFields(_data, "EthGetBlockBy " + _data.getKey(),
            {{"logsBloom", {{DataType::String}, jsonField::Required}},
             ...
             {"pstotal", {{DataType::String}, jsonField::Required}},         //增加新链新增加的数据结构成员
             {"psAverage", {{DataType::String}, jsonField::Required}},         //增加新链新增加的数据结构成员
             ...
             {"tasksRoot", {{DataType::String}, jsonField::Required}},         //增加新链新增加的数据结构成员
             {"CreditHash", {{DataType::String}, jsonField::Required}},         //增加新链新增加的数据结构成员
